...
import product from "../assets/products/INJETOR CLEANER.png";
...
export const InjectorCleaner: React.FC = () => {
  return (
    <>
      <NavBar />
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-8 flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Tuangkan ke tangki bahan bakar
            </p>

            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
              <li>Menghilangkan kerak di sistem injeksi</li>
              <li>Membersihkan nozel injektor</li>
              <li>Mengurangi konsumsi bahan bakar</li>
              <li>Memperpanjang umur injector</li>
            </ul>
          </div>
        </motion.div>
      </div>
