...
import product from "../assets/products/AIR ACCU.png";
...
export const AirACCU: React.FC = () => {
  return (
    <>
      <NavBar />

      {/* Showcase Section with blue-to-white background */}
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-blue-100 via-white to-white px-6 py-10">
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
            <h2 className="text-2xl font-bold text-blue-700 mb-2">Air ACCU</h2>
            ...
            <p className="text-gray-600 mb-4">Tuangkan ke baterai aki</p>

            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>Menjaga kinerja aki</li>
              <li>Mencegah kerusakan sel aki</li>
              <li>Memperpanjang umur aki</li>
              <li>Menjaga stabilitas tegangan</li>
              <li>Meningkatkan efisiensi pengisian daya</li>
            </ul>
          </div>
        </motion.div>
      </div>
