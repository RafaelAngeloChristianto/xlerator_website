...
import product from "../assets/products/BRAKE PART CLEANER.png";
...
export const BrakePartsCleaner: React.FC = () => {
  return (
    <>
      <NavBar />
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-4">
              Semprot pada sistem brake part dan brake shoes
            </p>

            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>
                Untuk membersihkan tromol rem, kampas rem, pegas, plat kopling,
                rem cakram, silinder roda dari kotoran
              </li>
            </ul>
          </div>
        </motion.div>
