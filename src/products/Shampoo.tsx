...
import product from "../assets/products/SHAMPO.png";
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-4">
              Campur dengan air, cuci dengan spons/lap, bilas hingga bersih,
              lalu keringkan
            </p>

            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>Membersihkan kotoran dan noda</li>
              <li>Mencegah kerusakan pada cat dan permukaan kendaraan</li>
              <li>Menjaga kilap dan keindahan cat</li>
            </ul>
          </div>
        </motion.div>
      </div>
