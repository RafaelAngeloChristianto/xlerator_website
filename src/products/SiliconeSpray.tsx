...
import product from "../assets/products/SILICONE CLEANER.png";
...
export const SiliconeSpray: React.FC = () => {
  return (
    <>
      <NavBar />
      <div className="flex justify-center items-center min-h-screen bg-gray-100-to-br px-6 py-10">
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <h3 className="text-lg font-semibold text-gray-600 mb-4">250 ml</h3>

            <h4 className="text-md font-semibold text-gray-800 mb-1">
              Aplikasi
            </h4>
            <p className="text-gray-600 mb-4">
              Kocok, semprot tipis pada permukaan bersih, biarkan kering
            </p>

            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>Menghilangkan bunyi gesekan berlebih</li>
              <li>Melumasi dan mencegah gesekan</li>
              <li>Merawat komponen plastik dan karet</li>
              <li>Mencegah karat & melindungi permukaan</li>
            </ul>
          </div>
        </motion.div>
      </div>
