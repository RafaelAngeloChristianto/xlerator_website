...
import product from "../assets/products/SUPER ENGINE CONDITIONER.png";
...
export const SuperEngineConditioner: React.FC = () => {
  return (
    <>
      <NavBar />
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-8 flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Semprotkan pada part yang akan dibersihkan sesuai kebutuhan
            </p>

            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
              <li>Membersihkan inlet valve, sistem injeksi</li>
              <li>
                Menghilangkan residu yang menempel seperti, minyak, resin, dan
                kotoran
              </li>
