...
import product from "../assets/products/CARBON CLEANER.png";
...
export const CarbonCleaner: React.FC = () => {
  return (
    <>
      <NavBar />
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              ...
              <li>
                Menghilangkan kotoran yang terjadi karena karbon yang berlebihan
              </li>
