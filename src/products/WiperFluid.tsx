...
import product from "../assets/products/WIPER.png";
...
export const WiperFluid: React.FC = () => {
  return (
    <>
      <NavBar />
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-blue-100 via-white to-white px-6 py-10">
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <h3 className="text-lg font-semibold text-gray-600 mb-4">130 ml</h3>

            <h4 className="text-md font-semibold text-gray-800 mb-1">
              Aplikasi
            </h4>
            <p className="text-gray-600 mb-4">Tuangkan ke tangki wiper.</p>

            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>
                Membersihkan kotoran yang menempel pada permukaan kaca depan
                (windshield)
              </li>
              <li>
                Mempunyai anti gores untuk tetap menjaga kaca mobil tetap bersih
              </li>
            </ul>
          </div>
        </motion.div>
