...
export const Gasoline: React.FC = () => {
  const products = [
    { name: "Catalytic and Chamber Cleaner", image: catalytic, link: "/catalytic" },
    { name: "Fuel Tank Cleaner", image: fueltankcleaner, link:"/fueltankcleaner" },
    { name: "Injector Cleaner", image: injectorcleaner, link:"/injectorcleaner"},
    { name: "Super Engine Cleaner", image: superenginecleaner, link:"/superengineconditioner"},
    { name: "Carbon Cleaner", image: carboncleaner, link:"/carboncleaner" },
  ];
