...
export const ServiceProduct: React.FC = () => {
  const products = [
    {
            ...
            <div className="flex flex-wrap justify-center gap-8">
              ...
              <Link to="/engine">
                <motion.div
                  ...
                  className="flex flex-col items-center bg-blue-100 p-4 rounded-2xl shadow-md hover:shadow-xl transition"
                >
                  <img src={engine} className="w-24 h-24 object-contain mb-2" />
                </motion.div>
              </Link>
              ...
              <Link to="/diesel">
                <motion.div
                  ...
                  className="flex flex-col items-center bg-blue-100 p-4 rounded-2xl shadow-md hover:shadow-xl transition"
                >
                  <img src={diesel} className="w-55 h-24 object-contain mb-2" />
                </motion.div>
              </Link>
            </div>
          </motion.div>
